...
export function Topbar({ title, breadcrumb, right, onOpenCmd }: Props) {
  ...
  return (
    <div style={{
      ...
      {/* Theme toggle */}
      <button onClick={toggle} title={theme === 'dark' ? 'Açık tema' : 'Koyu tema'}
        style={{ width: 32, height: 32, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'transparent', border: '1px solid var(--border-c)', borderRadius: 6, color: 'var(--text-2)', cursor: 'pointer' }}>
